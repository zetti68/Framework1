...
+ (jdouble)atan2WithDouble:(jdouble)x
...
__attribute__((always_inline)) inline void JavaLangMath_init() {}
...
FOUNDATION_EXPORT jdouble JavaLangMath_atan2WithDouble_withDouble_(jdouble x, jdouble y);
