...
FOUNDATION_EXPORT JavaUtilFormatter_BigDecimalLayoutFormEnum *JavaUtilFormatter_BigDecimalLayoutFormEnum_valueOfWithNSString_(NSString *name);- (id)copyWithZone:(NSZone *)zone;
...
J2OBJC_STATIC_FIELD_GETTER(JavaUtilFormatter_BigDecimalLayoutFormEnum, SCIENTIFIC, JavaUtilFormatter_BigDecimalLayoutFormEnum *)
...
J2OBJC_STATIC_FIELD_GETTER(JavaUtilFormatter_BigDecimalLayoutFormEnum, DECIMAL_FLOAT, JavaUtilFormatter_BigDecimalLayoutFormEnum *)
...
__attribute__((always_inline)) inline void JavaUtilFormatter_CachedDecimalFormat_init() {}
...
__attribute__((always_inline)) inline void JavaUtilFormatter_FormatToken_init() {}
...
__attribute__((always_inline)) inline void JavaUtilFormatter_FormatSpecifierParser_init() {}
...
__attribute__((always_inline)) inline void JavaUtilFormatter_$1_init() {}
