...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/guava/sources/com/google/common/collect/Range.java
//
...
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_openWithJavaLangComparable_withJavaLangComparable_(id lower, id upper);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_closedWithJavaLangComparable_withJavaLangComparable_(id lower, id upper);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_closedOpenWithJavaLangComparable_withJavaLangComparable_(id lower, id upper);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_openClosedWithJavaLangComparable_withJavaLangComparable_(id lower, id upper);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_rangeWithJavaLangComparable_withComGoogleCommonCollectBoundTypeEnum_withJavaLangComparable_withComGoogleCommonCollectBoundTypeEnum_(id lower, ComGoogleCommonCollectBoundTypeEnum *lowerType, id upper, ComGoogleCommonCollectBoundTypeEnum *upperType);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_lessThanWithJavaLangComparable_(id endpoint);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_atMostWithJavaLangComparable_(id endpoint);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_upToWithJavaLangComparable_withComGoogleCommonCollectBoundTypeEnum_(id endpoint, ComGoogleCommonCollectBoundTypeEnum *boundType);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_greaterThanWithJavaLangComparable_(id endpoint);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_atLeastWithJavaLangComparable_(id endpoint);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_downToWithJavaLangComparable_withComGoogleCommonCollectBoundTypeEnum_(id endpoint, ComGoogleCommonCollectBoundTypeEnum *boundType);
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_all();
FOUNDATION_EXPORT ComGoogleCommonCollectRange *ComGoogleCommonCollectRange_singletonWithJavaLangComparable_(id value);
