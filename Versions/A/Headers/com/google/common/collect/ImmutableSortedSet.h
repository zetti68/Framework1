...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/guava/sources/com/google/common/collect/ImmutableSortedSet.java
//
...
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedSet *ComGoogleCommonCollectImmutableSortedSet_ofWithJavaLangComparable_(id element);
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedSet *ComGoogleCommonCollectImmutableSortedSet_ofWithJavaLangComparable_withJavaLangComparable_(id e1, id e2);
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedSet *ComGoogleCommonCollectImmutableSortedSet_ofWithJavaLangComparable_withJavaLangComparable_withJavaLangComparable_(id e1, id e2, id e3);
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedSet *ComGoogleCommonCollectImmutableSortedSet_ofWithJavaLangComparable_withJavaLangComparable_withJavaLangComparable_withJavaLangComparable_(id e1, id e2, id e3, id e4);
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedSet *ComGoogleCommonCollectImmutableSortedSet_ofWithJavaLangComparable_withJavaLangComparable_withJavaLangComparable_withJavaLangComparable_withJavaLangComparable_(id e1, id e2, id e3, id e4, id e5);
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedSet *ComGoogleCommonCollectImmutableSortedSet_ofWithJavaLangComparable_withJavaLangComparable_withJavaLangComparable_withJavaLangComparable_withJavaLangComparable_withJavaLangComparable_withJavaLangComparableArray_(id e1, id e2, id e3, id e4, id e5, id e6, IOSObjectArray *remaining);
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectImmutableSortedSet_Builder_init() {}
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectImmutableSortedSet_SerializedForm_init() {}
