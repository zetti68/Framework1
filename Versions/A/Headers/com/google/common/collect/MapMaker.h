...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/guava/sources/com/google/common/collect/MapMaker.java
//
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_init() {}
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_RemovalListener_init() {}
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_RemovalNotification_init() {}
...
FOUNDATION_EXPORT ComGoogleCommonCollectMapMaker_RemovalCauseEnum *ComGoogleCommonCollectMapMaker_RemovalCauseEnum_valueOfWithNSString_(NSString *name);- (id)copyWithZone:(NSZone *)zone;
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleCommonCollectMapMaker_RemovalCauseEnum, EXPLICIT, ComGoogleCommonCollectMapMaker_RemovalCauseEnum *)
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleCommonCollectMapMaker_RemovalCauseEnum, REPLACED, ComGoogleCommonCollectMapMaker_RemovalCauseEnum *)
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleCommonCollectMapMaker_RemovalCauseEnum, COLLECTED, ComGoogleCommonCollectMapMaker_RemovalCauseEnum *)
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleCommonCollectMapMaker_RemovalCauseEnum, EXPIRED, ComGoogleCommonCollectMapMaker_RemovalCauseEnum *)
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleCommonCollectMapMaker_RemovalCauseEnum, SIZE, ComGoogleCommonCollectMapMaker_RemovalCauseEnum *)
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_RemovalCauseEnum_$1_init() {}
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_RemovalCauseEnum_$2_init() {}
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_RemovalCauseEnum_$3_init() {}
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_RemovalCauseEnum_$4_init() {}
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_RemovalCauseEnum_$5_init() {}
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_NullConcurrentMap_init() {}
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_NullComputingConcurrentMap_init() {}
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectMapMaker_ComputingMapAdapter_init() {}
