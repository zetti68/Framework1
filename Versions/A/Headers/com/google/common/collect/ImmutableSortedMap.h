...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/guava/sources/com/google/common/collect/ImmutableSortedMap.java
//
...
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedMap *ComGoogleCommonCollectImmutableSortedMap_ofWithJavaLangComparable_withId_(id k1, id v1);
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedMap *ComGoogleCommonCollectImmutableSortedMap_ofWithJavaLangComparable_withId_withJavaLangComparable_withId_(id k1, id v1, id k2, id v2);
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedMap *ComGoogleCommonCollectImmutableSortedMap_ofWithJavaLangComparable_withId_withJavaLangComparable_withId_withJavaLangComparable_withId_(id k1, id v1, id k2, id v2, id k3, id v3);
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedMap *ComGoogleCommonCollectImmutableSortedMap_ofWithJavaLangComparable_withId_withJavaLangComparable_withId_withJavaLangComparable_withId_withJavaLangComparable_withId_(id k1, id v1, id k2, id v2, id k3, id v3, id k4, id v4);
FOUNDATION_EXPORT ComGoogleCommonCollectImmutableSortedMap *ComGoogleCommonCollectImmutableSortedMap_ofWithJavaLangComparable_withId_withJavaLangComparable_withId_withJavaLangComparable_withId_withJavaLangComparable_withId_withJavaLangComparable_withId_(id k1, id v1, id k2, id v2, id k3, id v3, id k4, id v4, id k5, id v5);
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectImmutableSortedMap_Builder_init() {}
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectImmutableSortedMap_SerializedForm_init() {}
...
__attribute__((always_inline)) inline void ComGoogleCommonCollectImmutableSortedMap_$1_init() {}
#endif
