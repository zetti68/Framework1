...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/guava/sources/com/google/common/primitives/SignedBytes.java
//
...
__attribute__((always_inline)) inline void ComGoogleCommonPrimitivesSignedBytes_init() {}
...
FOUNDATION_EXPORT ComGoogleCommonPrimitivesSignedBytes_LexicographicalComparatorEnum *ComGoogleCommonPrimitivesSignedBytes_LexicographicalComparatorEnum_valueOfWithNSString_(NSString *name);- (id)copyWithZone:(NSZone *)zone;
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleCommonPrimitivesSignedBytes_LexicographicalComparatorEnum, INSTANCE, ComGoogleCommonPrimitivesSignedBytes_LexicographicalComparatorEnum *)
#endif
