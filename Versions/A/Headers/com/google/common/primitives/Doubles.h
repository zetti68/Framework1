...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/guava/sources/com/google/common/primitives/Doubles.java
//
...
FOUNDATION_EXPORT ComGoogleCommonPrimitivesDoubles_LexicographicalComparatorEnum *ComGoogleCommonPrimitivesDoubles_LexicographicalComparatorEnum_valueOfWithNSString_(NSString *name);- (id)copyWithZone:(NSZone *)zone;
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleCommonPrimitivesDoubles_LexicographicalComparatorEnum, INSTANCE, ComGoogleCommonPrimitivesDoubles_LexicographicalComparatorEnum *)
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonPrimitivesDoubles_DoubleArrayAsList_init() {}
