...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/guava/sources/com/google/common/primitives/Longs.java
//
...
__attribute__((always_inline)) inline void ComGoogleCommonPrimitivesLongs_init() {}
...
FOUNDATION_EXPORT ComGoogleCommonPrimitivesLongs_LexicographicalComparatorEnum *ComGoogleCommonPrimitivesLongs_LexicographicalComparatorEnum_valueOfWithNSString_(NSString *name);- (id)copyWithZone:(NSZone *)zone;
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleCommonPrimitivesLongs_LexicographicalComparatorEnum, INSTANCE, ComGoogleCommonPrimitivesLongs_LexicographicalComparatorEnum *)
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonPrimitivesLongs_LongArrayAsList_init() {}
