...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/guava/sources/com/google/common/primitives/Shorts.java
//
...
__attribute__((always_inline)) inline void ComGoogleCommonPrimitivesShorts_init() {}
...
FOUNDATION_EXPORT ComGoogleCommonPrimitivesShorts_LexicographicalComparatorEnum *ComGoogleCommonPrimitivesShorts_LexicographicalComparatorEnum_valueOfWithNSString_(NSString *name);- (id)copyWithZone:(NSZone *)zone;
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleCommonPrimitivesShorts_LexicographicalComparatorEnum, INSTANCE, ComGoogleCommonPrimitivesShorts_LexicographicalComparatorEnum *)
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonPrimitivesShorts_ShortArrayAsList_init() {}
