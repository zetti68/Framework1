...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/guava/sources/com/google/common/primitives/Ints.java
//
...
__attribute__((always_inline)) inline void ComGoogleCommonPrimitivesInts_init() {}
...
FOUNDATION_EXPORT ComGoogleCommonPrimitivesInts_LexicographicalComparatorEnum *ComGoogleCommonPrimitivesInts_LexicographicalComparatorEnum_valueOfWithNSString_(NSString *name);- (id)copyWithZone:(NSZone *)zone;
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleCommonPrimitivesInts_LexicographicalComparatorEnum, INSTANCE, ComGoogleCommonPrimitivesInts_LexicographicalComparatorEnum *)
#endif
...
__attribute__((always_inline)) inline void ComGoogleCommonPrimitivesInts_IntArrayAsList_init() {}
