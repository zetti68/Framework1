...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/testing/mockito/build_result/java/org/mockito/exceptions/Reporter.java
//
...
- (id)locationsOfWithJavaUtilCollection:(id<JavaUtilCollection>)matchers;
...
- (NSString *)createWantedButNotInvokedMessageWithOrgMockitoInvocationDescribedInvocation:(id<OrgMockitoInvocationDescribedInvocation>)wanted;
...
- (NSString *)createTooManyInvocationsMessageWithInt:(jint)wantedCount
                                             withInt:(jint)actualCount
         withOrgMockitoInvocationDescribedInvocation:(id<OrgMockitoInvocationDescribedInvocation>)wanted
                    withOrgMockitoInvocationLocation:(id<OrgMockitoInvocationLocation>)firstUndesired;
...
- (NSString *)createTooLittleInvocationsMessageWithOrgMockitoInternalReportingDiscrepancy:(OrgMockitoInternalReportingDiscrepancy *)discrepancy
                                              withOrgMockitoInvocationDescribedInvocation:(id<OrgMockitoInvocationDescribedInvocation>)wanted
                                                         withOrgMockitoInvocationLocation:(id<OrgMockitoInvocationLocation>)lastActualInvocation;
...
- (JavaLangStringBuilder *)possibleArgumentTypesOfWithOrgMockitoInvocationInvocationOnMock:(id<OrgMockitoInvocationInvocationOnMock>)invocation;
...
__attribute__((always_inline)) inline void OrgMockitoExceptionsReporter_init() {}
