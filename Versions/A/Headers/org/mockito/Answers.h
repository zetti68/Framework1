...
//  source: /Users/Zetzsche/Development/j2objc-0.9.4/testing/mockito/build_result/java/org/mockito/Answers.java
//
...
- (instancetype)initWithOrgMockitoStubbingAnswer:(id<OrgMockitoStubbingAnswer>)implementation
...
FOUNDATION_EXPORT OrgMockitoAnswersEnum *OrgMockitoAnswersEnum_valueOfWithNSString_(NSString *name);- (id)copyWithZone:(NSZone *)zone;
